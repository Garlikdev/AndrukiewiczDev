...
export default function Project({
  ...
  return (
    <motion.section
      ...
      ref={ref}
      className='flex flex-col-reverse sm:flex-col group even:sm:flex-row-reverse bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 hover:dark:bg-gray-700 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-fit shadow-highlight rounded-lg'
    >
