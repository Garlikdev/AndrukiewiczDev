...
export default function Contact() {
  ...
  return (
    <motion.section
      id='contact'
      ref={ref}
      className='bg-gray-100 dark:bg-gray-950 flex flex-col w-full py-8 px-16 rounded-lg shadow-highlight mt-16 gap-4 items-center text-center mb-16 max-w-3xl'
